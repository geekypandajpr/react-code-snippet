    ...
    <Container className={classes.cardGrid} maxWidth="lg">
      <Grid container spacing={4}>
        ...
        >
          ...
          <div id="tSupplyBox">
            <Typography>
              <img alt="" src={IMAGES_URL.TIP_ICON} id="tipImage" />
            </Typography>
            <div id="tSupplytext">LYMPHATIC TUBE</div>
          </div>

          <div id="tSupplyBox">
            <div id="tSupplytext">
              <img alt="" src={IMAGES_URL.STROKE_ICON} style={{ float: "left" }} />{" "}
                  DOUBLE PUMP
                </div>
        ...
        >
          ...
          <div id="tTreatmentBox">
            <img alt="" src={IMAGES_URL.TREATMENT_IMG1} id="tTreatmentimg" />
            <div id="tTreatmentBoxtitle"> STEP 1</div>
          </div>

          <div id="tTreatmentBox">
            <img alt="" src={IMAGES_URL.TREATMENT_IMG2} id="tTreatmentimg" />
            <div id="tTreatmentBoxtitle"> STEP 2</div>
          </div>

          <div id="tTreatmentBox">
            <img alt="" src={IMAGES_URL.TREATMENT_IMG3} id="tTreatmentimg" />
            <div id="tTreatmentBoxtitle"> STEP 3</div>
          </div>

          <div id="tTreatmentBox">
            <img alt="" src={IMAGES_URL.TREATMENT_IMG4} id="tTreatmentimg" />
            <div id="tTreatmentBoxtitle"> STEP 4</div>
          </div>

          <div id="tTreatmentBox">
            <img alt="" src={IMAGES_URL.TREATMENT_IMG5} id="tTreatmentimg" />
            <div id="tTreatmentBoxtitle"> STEP 5</div>
          </div>
        </Grid>
      </Grid>
      {/* Tab 1 End */}
