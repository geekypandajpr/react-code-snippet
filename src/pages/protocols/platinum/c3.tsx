    ...
    <Container className={classes.cardGrid} maxWidth="lg">
      ...
      <Grid container spacing={4}>
        <Grid item xs={12} sm={12} md={12}>
          ...
          <div className={classes.TreatmentSubTitle}>Glysal</div>
        </Grid>
        ...
        >
          ...
          <div id="tSupplyBox1">
            ...
            <div id="tSupplytext1">SMALL TEAL TIP</div>
          </div>

          <div id="tSupplyBox1">
            <Typography>
              <img alt="" src={IMAGES_URL.SOLUTION_ICON2} id="tipImage1" />
            </Typography>
            <div id="tSupplytext1">CHOICE OF GLYSAL</div>
          </div>
        ...
        >
          ...
          <div id="tTreatmentBox">
            <img alt="" src={IMAGES_URL.TREATMENT_IMG21} id="tTreatmentimg" />
            <div id="tTreatmentBoxtitle"> STEP 1</div>
          </div>

          <div id="tTreatmentBox">
            <img alt="" src={IMAGES_URL.TREATMENT_IMG22} id="tTreatmentimg" />
            <div id="tTreatmentBoxtitle"> STEP 2</div>
          </div>

          <div id="tTreatmentBox">
            <img alt="" src={IMAGES_URL.TREATMENT_IMG23} id="tTreatmentimg" />
